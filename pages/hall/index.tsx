    ...
    return (
        <>
            <Head>
                ...
                <meta name="Описание" content="Описание страницы Hall, гигансткое помещение для тусовки с друзьями, отдохните кломпанией и отметьте дни рожения, проведите корпоративы, посмотрите фильмы"/>
