    ...
    return (
        <>
            <Head>
                ...
                <meta name="Описание" content="Описание страницы Equipment, огромное количество оборудования, проектор, аудио система, колонки, подсветка, светодиоды, лазер, микрофоны, микшер"/>
