        ...
        <div className="sub-container">
            <div className={styles.description__container__left}>
                ...
                <p>
                    ...
                    действует в отношении всей информации, которую сайт welcome_party54, (далее – wp54) расположенный
                    на доменном имени wp-54.ru (а также его субдоменах), может получить о Пользователе во время
                    использования сайта wp-54.ru (а также его субдоменов), его программ и его продуктов.
                </p>
                <h3>
                ...
                <ul>
                    <li>
                        ...
                        сайтом welcome_party54, которые организуют и (или) осуществляют обработку персональных данных,
                        а
                    ...
                    <li>
                        1.1.5. «Сайт welcome_party54» - это совокупность связанных между собой веб-страниц, размещенных
                        в
                        сети Интернет по уникальному адресу (URL): wp-54.ru, а также его субдоменах.
                    </li>

                    <li>
                        1.1.6. «Субдомены» - это страницы или совокупность страниц, расположенные на доменах третьего
                        уровня, принадлежащие сайту welcome_party54, а также другие временные страницы, внизу который
                    ...
                    <li>
                        1.1.9. «Пользователь сайта welcome_party54» (далее Пользователь) – лицо, имеющее доступ к
                        сайту
                        welcome_party54, посредством сети Интернет и использующее информацию, материалы и продукты
                        сайта
                        welcome_party54.
                    </li>
                </ul>
                ...
                <p>
                    2.1. Использование сайта welcome_party54 Пользователем означает согласие с настоящей Политикой
                ...
                <p>
                    ...
                    использование сайта welcome_party54.
                </p>
                <p>
                    2.3. Настоящая Политика конфиденциальности применяется к сайту welcome_party54. wp54 не
                    контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь может перейти
                    по ссылкам, доступным на сайте welcome_party54.
                ...
                <p>
                    ...
                    по
                    запросу Администрации при регистрации на сайте welcome_party54 или при подписке на информационную
                    e-mail рассылку.
                </p>
                ...
                <p>
                    <strong>
                        ...
                        конфиденциальности,
                        предоставляются Пользователем путём заполнения форм на сайте welcome_party54 и включают в себя
                ...
                <ul>
                    <li>
                        4.1.1. Идентификации Пользователя, зарегистрированного на сайте welcome_party54 для его
                        дальнейшей
                        авторизации.
                    </li>
                    <li>
                        4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта welcome_party54.
                    </li>
                    <li>
                        4.1.3. Установления с Пользователем обратной связи, включая направление уведомлений, запросов,
                        касающихся использования сайта welcome_party54, обработки запросов и заявок от Пользователя.
                    </li>
                    <li>
                    ...
                    <li>
                        4.1.6. Создания учетной записи для использования частей сайта welcome_party54, если
                        Пользователь
                        дал
                ...
                <ul>
                    <li>
                        ...
                        использования сайта welcome_party54, и давать согласие на их обработку.
                    </li>
                    <li>
                ...
                <p>
                    ...
                    ограничиваясь:
                    файлы с данными, тексты и т. д.), к которой он может иметь доступ как к части сайта welcome_party54,
                    несет лицо, предоставившее такую информацию.
                </p>
                <p>
                    7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта welcome_party54,
                    может являться объектом интеллектуальной собственности, права на который защищены и принадлежат
                    другим
                    Пользователям, партнерам или рекламодателям, которые размещают такую информацию на сайте welcome_party54.
                </p>
                <p>
                ...
                <p>
                    ...
                    на
                    сайте welcome_party54) допускается их распространение при условии, что будет дана ссылка на wp54.
                </p>
                <p>
                    ...
                    коммуникационных данных, содержащихся на сайте welcome_party54 или передаваемых через него.
                </p>
                <p>
                ...
                <p>
                    ...
                    сайте
                    welcome_party54, включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого
                ...
                <p>
                    9.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте welcome_party54, если иное не предусмотрено новой редакцией Политики конфиденциальности.
                </p>
                <p>
