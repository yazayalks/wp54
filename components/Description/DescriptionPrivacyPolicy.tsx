...
const DescriptionPrivacyPolicy: FC = () => {
    return (
        <div className="sub-container">
            <div className={`${styles.description__container} ${styles.description__container__left}`}>
                ...
                <p>
                    ...
                    действует в отношении всей информации, которую сайт Welcome party 54, (далее – wp54) расположенный
                    на доменном имени wp54.ru (а также его субдоменах), может получить о Пользователе во время
                    использования сайта wp54.ru (а также его субдоменов), его программ и его продуктов.
                </p>
                <h3>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        в
                        сети Интернет по уникальному адресу (URL): wp54.ru, а также его субдоменах.
                    </li>
                    ...
                    <li>
                        ...
                        Пользователь
                        получает доступ на wp54.
                    </li>
                    <li>
                        1.1.9. «Пользователь сайта Welcome party 54 » (далее Пользователь) – лицо, имеющее доступ к
                        сайту
                        Welcome party 54, посредством сети Интернет и использующее информацию, материалы и продукты
                        сайта
                        Welcome party 54.
                    </li>
                </ul>
                ...
                <p>
                    2.3. Настоящая Политика конфиденциальности применяется к сайту Welcome party 54. wp54 не
                    контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь может перейти
                    по ссылкам, доступным на сайте Welcome party 54.
                ...
                <p>
                    ...
                    по
                    запросу Администрации при регистрации на сайте Welcome party 54 или при подписке на информационную
                    e-mail рассылку.
                </p>
                ...
                <p>
                    <strong>
                        ...
                        конфиденциальности,
                        предоставляются Пользователем путём заполнения форм на сайте Welcome party 54 и включают в себя
                ...
                <p>
                    3.3.2. wp54 осуществляет сбор статистики об IP-адресах своих посетителей. Данная информация
                    используется
                ...
                <ul>
                    ...
                    <li>
                        ...
                        иных
                        сведений от имени сайта Welcome party 54.
                    </li>
                </ul>
                <h3>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        Пользователь
                        вправе требовать от Администрации уточнения его персональных данных, их блокирования или
                        уничтожения
                        в
                ...
                <p>
                    ...
                    числе
                    законов о рекламе, о защите авторских и смежных прав, об охране товарных знаков и знаков
                    обслуживания,
                ...
                <p>
                    ...
                    ограничиваясь:
                    файлы с данными, тексты и т. д.), к которой он может иметь доступ как к части сайта Welcome party
                    54,
                    несет лицо, предоставившее такую информацию.
                </p>
                <p>
                    7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта Welcome party 54,
                    может являться объектом интеллектуальной собственности, права на который защищены и принадлежат
                    другим
                    Пользователям, партнерам или рекламодателям, которые размещают такую информацию на сайте Welcome
                    party
                    54.
                </p>
                <p>
                ...
                <p>
                    ...
                    на
                    сайте Welcome party 54) допускается их распространение при условии, что будет дана ссылка на wp54.
                </p>
                <p>
                    ...
                    коммуникационных данных, содержащихся на сайте Welcome party 54 или передаваемых через него.
                </p>
                <p>
                ...
                <p>
                    ...
                    сайте
                    Welcome party 54, включая, но не ограничиваясь: информацию, защищенную авторским правом, без прямого
                ...
                <p>
                    ...
                    party
                    54, если иное не предусмотрено новой редакцией Политики конфиденциальности.
                </p>
                <p>
                    9.3. Все предложения или вопросы касательно настоящей Политики конфиденциальности следует сообщать
                    по
                    адресу: welcomeparty54@gmail.com
                </p>
                <p>
                    9.4. Действующая Политика конфиденциальности размещена на странице по адресу
                    http://wp54.ru/politika.html
                </p>
                <p>
                    <strong> Обновлено: 05 Февраля 2023 года</strong>
                </p>
                <p>
                    <strong>г. Новосибирск, lks studio</strong>
                </p>
            </div>
        </div>
    );
...
export default DescriptionPrivacyPolicy;